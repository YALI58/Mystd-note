...
如图3-1所示，逻辑结构可分为“线性”和“非线性” 两大类。线性结构比较直观，指数据在逻辑关系上呈线性排列；非线性结构则相反，呈非线性排列。
- 线性结构数据：数组、链表、栈、队列、哈希表，元素之间是一对一的顺序关系。
- 非线性数据结构：树、堆、图、哈希表。
...
## 3.1.2   物理结构：连续与分散[¶](https://www.hello-algo.com/chapter_data_structure/classification_of_data_structure/#312 "Permanent link")
...
# 3.5   小结[¶](https://www.hello-algo.com/chapter_data_structure/summary/#35 "Permanent link")

### 1.   重点回顾[¶](https://www.hello-algo.com/chapter_data_structure/summary/#1 "Permanent link")
...
### 2.   Q & A[¶](https://www.hello-algo.com/chapter_data_structure/summary/#2-q-a "Permanent link")
